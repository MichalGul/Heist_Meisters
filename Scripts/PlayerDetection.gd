...
#tutaj tak naprawde mozna liczyc dot product
...
func Player_is_in_LOS():
	...
	#Tutaj robimi customowy raycast z kamery. Jezeli trafi na playara to tru jak na cos innego zdefiniowanegpo w collison mask to false
